<?php  //[STAMP] fbfd1a282e3bd75f35f839d038c0f862
...
trait AcceptanceTesterActions
{
     ...
     *
     *
     * @see \Helper\Acceptance::collectData()
     */
    public function collectData($a1, $a2, $a3) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('collectData', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Acceptance::saveCSVReport()
     */
    public function saveCSVReport($data, $file_name) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('saveCSVReport', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Acceptance::compareResults()
     */
    public function compareResults($expected, $actual) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('compareResults', func_get_args()));
    }
}
